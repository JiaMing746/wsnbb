...
import com.Sunshine.library.shell.LocationHelper
...
class SystemScene(private var context: Context) {
    ...
    private fun switchLowPowerModeShell(powersave: Boolean) {
        ...
        if (lowPowerModeShell!!.isEmpty()) {
            lowPowerModeShell = com.Sunshine.common.shared.FileWrite.writePrivateShellFile("addin/power_save_set.sh", "addin/power_save_set.sh", context)
        }
