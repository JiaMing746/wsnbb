        ...
        if (compile_method == "reset") {
            ...
            for (packageName in packageNames) {
                if (true) {
                    ...
                    cmdBuilder.append("am broadcast -n com.Sunshine.ToolBox/com.Sunshine.ToolBox.ReceiverCompileState --ei current $current --ei total $total --es packageName $packageName\n")
            ...
            cmdBuilder.append("am broadcast -n com.Sunshine.ToolBox/com.Sunshine.ToolBox.ReceiverCompileState --ei current $total --ei total $total --es packageName OK\n")
