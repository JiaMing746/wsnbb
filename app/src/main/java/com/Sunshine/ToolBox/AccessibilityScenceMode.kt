...
import com.Sunshine.data.EventBus
import com.Sunshine.data.EventType
import com.Sunshine.data.GlobalStatus
import com.Sunshine.data.IEventReceiver
import com.Sunshine.library.basic.InputMethodApp
import com.Sunshine.library.basic.LauncherApps
import com.Sunshine.library.calculator.Flags
import com.Sunshine.scene_mode.AppSwitchHandler
import com.Sunshine.scene_mode.AutoClickInstall
import com.Sunshine.scene_mode.AutoSkipAd
import com.Sunshine.store.SpfConfig
import com.Sunshine.utils.AutoSkipCloudData
import com.Sunshine.ToolBox.popup.FloatLogView
...
public class AccessibilityScenceMode : AccessibilityService(), IEventReceiver {
    ...
    override fun onAccessibilityEvent(event: AccessibilityEvent) {
        ...
        */
        ...
        if (packageName != null) {
            when {
                packageName == "com.Sunshine.gesture" || packageName == "com.Sunshine.filter" -> {
                    return
                }
                /*
                ...
                */
                // packageName == "com.Sunshine.ToolBox" -> return
        ...
        if (effectiveWindows.isNotEmpty()) {
            try {
                ...
                for (window in effectiveWindows) {
                    ...
                    if (wp == null || wp == "android" || wp == "com.android.systemui" || wp == "com.miui.freeform" || wp == "com.Sunshine.gesture" || wp == "com.Sunshine.filter" || wp == "com.android.permissioncontroller") {
                        continue
                    }
                    */
